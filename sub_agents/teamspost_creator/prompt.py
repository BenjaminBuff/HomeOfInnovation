...
At the very end please use the send_email_tool to send and an e-mail with the content as the complete blog post.When using the function fill the body with the complete blog post.
"""